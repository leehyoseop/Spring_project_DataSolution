...
<link rel="stylesheet" href="resources/categoryCSS/Banksearch.css">
</head>
<body bgcolor="#EAEAEA">
			...
			navigator.geolocation
					.getCurrentPosition(function(position) {
						...
						function addMarker(position, order) {
							...
							var imageSrc = 'resources/mapimg/bank.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
						...
						function displayPlaceInfo(place) {
							...
							//				location.href = "bankplacefunc?category=bank&place_name="
							//						+ place.place_name
							//						+ "&lat="
							//						+ place.y
							//						+ "&lng=" + place.x;
