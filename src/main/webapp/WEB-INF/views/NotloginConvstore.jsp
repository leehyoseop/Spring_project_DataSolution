...
<link rel="stylesheet" href="resources/categoryCSS/Convstoresearch.css">
</head>
<body bgcolor="#EAEAEA">
	<table height="50px" align="center">
		<tr>
			<td align="right" style="font-family: SBugroM;">로그인 후 이용하실 수 있습니다</td>
			<td align="left">
	...
	<c:forEach var="p" items="${place }">
		${p.id }&nbsp;&nbsp;${p.day }&nbsp;&nbsp;${p.category }&nbsp;&nbsp;${p.place_name }&nbsp;&nbsp;${p.lat }&nbsp;&nbsp;${p.lng }
	</c:forEach>
	<div class="map_wrap">
		<div id="map"></div>
		<ul id="category">
			<li id="CS2" data-order="0"><span class="category_bg bank"></span>
				편의점</li>
		</ul>
	</div>
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=71799ec3236b701e549dc7dce99bcd31&libraries=services"></script>
	<script>
			...
			navigator.geolocation
					.getCurrentPosition(function(position) {
						...
						function addMarker(position, order) {
							...
							var imageSrc = 'resources/mapimg/convstore.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
							imageSize = new kakao.maps.Size(24, 24), // 마커 이미지의 크기
							imgOptions = {
								spriteSize : new kakao.maps.Size(24, 24), // 스프라이트 이미지의 크기
						...
						function displayPlaceInfo(place) {
							...
							//setTimeout(
							//		function() {
							//			var chk = confirm('방문하시겠습니까?');
							//			if (chk == true) {
							//				console.log(place.place_name);
							//				console.log(place.y);
											//location.href="/경로?보낼변수명=" + 값 + "&보낼변수명2=" + 값 ..... ;
							//				location.href = "convstoreplacefunc?category=convstore&place_name="
							//						+ place.place_name
							//						+ "&lat="
							//						+ place.y
							//						+ "&lng=" + place.x;
