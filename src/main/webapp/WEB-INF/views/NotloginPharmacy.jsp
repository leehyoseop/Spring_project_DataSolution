...
<link rel="stylesheet" href="resources/categoryCSS/Pharmacysearch.css">
</head>
<body bgcolor="#EAEAEA">
	...
	<div class="map_wrap">
		<div id="map"></div>
		<ul id="category">
			<li id="PM9" data-order="0"><span class="category_bg bank"></span>
				약국</li>
		</ul>
	</div>
			...
			navigator.geolocation
					.getCurrentPosition(function(position) {
						...
						function addMarker(position, order) {
							...
							var imageSrc = 'resources/mapimg/pharmacy.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
						...
						function displayPlaceInfo(place) {
							...
							//				location.href = "pharmacyplacefunc?category=pharmacy&place_name="
							//						+ place.place_name
							//						+ "&lat="
							//						+ place.y
							//						+ "&lng=" + place.x;
